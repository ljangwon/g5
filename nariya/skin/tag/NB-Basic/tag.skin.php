	...
	<div id="tag_btn_top" class="clearfix f-de font-weight-normal mb-2 pl-3 pr-2 px-sm-0">
		<div class="d-flex align-items-center">
			...
			<div class="btn-group" role="group">
				<button type="button" class="btn btn_b01 nofocus py-1" title="태그 검색" data-toggle="collapse" data-target="#tag_search" aria-expanded="false" aria-controls="tag_search">
